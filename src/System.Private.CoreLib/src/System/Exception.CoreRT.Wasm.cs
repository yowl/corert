...
namespace System
{
    public partial class Exception
    {
        ...
        {
            AppendExceptionStackFrameWasm(exception, new StackTrace().ToString());
            //RhpThrowEx(exception); TODO: can't do this currently as not handling the transition unmanaged->managed in the landing pads, so this is done from LLVM
        }
